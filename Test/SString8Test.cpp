...
namespace
{
	...
	bool tests()
	{
		using namespace UTest2NS;

		"String8TestConstructorCountChar"_testy =
			[]
			{
				{
		...
		"String8TestConstructorStringView"_testy =
			[]
			{
				{
		...
		"String8TestConstructorString"_testy =
			[]
			{
				{
		...
		"String8Testoperatotstdstringview"_testy =
			[]
			{
				{
					const std::string_view str;
		...
		"String8TestConstructorOtherPos"_testy =
			[]
			{
		...
		"String8TestConstructorOtherPosCount"_testy =
			[]
			{
		...
		"String8TestConstructorCharStarCount"_testy =
			[]
			{
		...
		"String8TestConstructorCharStar"_testy =
			[]
			{
		...
		"String8TestConstructorInputItFirstLast"_testy =
			[]
			{
		...
		"String8TestConstructorInitialiserList"_testy =
			[]
			{
		...
		"String8TestConstructorStringViewLike"_testy =
			[]
			{
				// can throw
		...
		"String8TestConstructorStringViewLikePosN"_testy =
			[]
			{
		...
		"String8TestCppReferenceConstructorTests"_testy =
			[]
			{
				{
					std::string s1;
		...
		"SString8TestConstructorCopy"_testy =
			[]
			{
		...
		"SString8TestConstructorMove"_testy =
			[]
			{
				const std::string_view shorttext = "abcdefg";
				const std::string_view longtext = "abcdefghijklmnopqrstuvwxyz";
		...
		"SString8TestAssignmentMove"_testy =
			[]
			{
				const std::string_view shorttext = "abcdefg";
				const std::string_view longtext = "abcdefghijklmnopqrstuvwxyz";
		...
		"SString8TestSpaceshipEqEq"_testy =
			[]
			{
		...
		"SString8TestEmbeddedNulls"_testy =
			[]
			{
